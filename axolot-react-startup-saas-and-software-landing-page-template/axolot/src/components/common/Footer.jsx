                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-7 col-md-7">
                                    <p>{this.props.copyRightText} <b>Hamm Solutions</b>. All Rights Reserved.</p>
                                    <br></br>Designed by <a href="http://julianhamm.co.uk" target="_blank">Dr Julian Hamm</a><br/>
                                </div>
