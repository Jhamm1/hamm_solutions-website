...
Team.defaultProps = {
    ...
    sectionDescription:  "Dr Julian Hamm is Director at Hamm solutions in charge of leading the overall strategic direction of the company. He is also an IT consultant contracted at various companies as a software engineer, advising companies on user experience, software architecture and automation solutions to deliver quality software products. He has been involved in several commercial IT transformation and migration projects to R&D projects that have both commercial and societal impact. Prior to starting Hamm solutions, Julian completed a PhD in computer science at Brunel University, where he investigated the use of mobile 3D visualisation technology to address the limitations of the existing clinical guidance tools used by older patients to perform home-based assessments. This research project was a PhD scholarship fully funded by EPSRC. During his time as a doctoral student, Julian published a number of research papers in peer-reviewed computer science and health informatic journals. He was also booked for many speaking engagements on his research topic to speak on the societal benefits and the impact emerging technologies have on the healthcare provision. He was also booked for many speaking engagements on his research topic to speak on the potential societal and healthcare provision impact. Dr Hamm has deputised for Directors of QA and Engineering during internal auditing and software releases, and have no issues with supporting in such capacity, where appropriate. He is a member of the British Computer Society, certified Project Manager and have gained many other industry recognised certifications in recent years."
